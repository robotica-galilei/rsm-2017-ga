...
class tof:
    def __init__(self, pins, addresses):
        #Init routine
        # tof_60_pins = {'60_NO' : 'gpio66', '60_NE' : 'gpio67', '60_SO' : 'gpio69', '60_SE' : 'gpio68', '60_EN' : 'gpio45', '60_ES' : 'gpio44', '60_ON' : 'gpio23', '60_OS' : 'gpio26'}
        # tof_60_addresses = {'60_NO' : 0x20, '60_NE' : 0x21 ,'60_SO' : 0x22, '60_SE' : 0x23, '60_EN' : 0x24, '60_ES' : 0x25, '60_ON' : 0x26, '60_OS' : 0x27}
        self.sens = {}
